...
class AuditRecordModel(TimestampMixin, Base):
    ...
    actor: Mapped[dict] = mapped_column(JSONColumn, nullable=False)
    ...
    trace: Mapped[dict | None] = mapped_column(JSONColumn, nullable=True)
    ai_call: Mapped[dict | None] = mapped_column(JSONColumn, nullable=True)
