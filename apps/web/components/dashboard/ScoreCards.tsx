  ...
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
      ...
      <Card grain className="flex items-center gap-6">
        <ScoreRing value={COMPLIANCE_SCORE.value} caption="Score" tone="success" />
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 text-xs text-foreground-muted">{COMPLIANCE_SCORE.caption}</p>
          <div className="mt-4 flex items-center gap-2">
            <Badge tone="success" dot>
              On track
            </Badge>
            <span className="text-2xs text-foreground-muted">Target {COMPLIANCE_SCORE.target}</span>
          </div>
        </div>
      </Card>
      ...
      {/* Overall Risk Score */}
      <Card grain className="flex items-center gap-6">
        <ScoreRing value={RISK_SCORE.value} caption="Index" tone="warning" />
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
          ...
          <p className="mt-1.5 text-xs text-foreground-muted">{RISK_SCORE.caption}</p>
          <div className="mt-4 flex items-center gap-2">
            <Badge tone="warning" dot>
              {RISK_SCORE.band}
            </Badge>
            <span className="text-2xs text-foreground-muted">Improving QoQ</span>
          </div>
        </div>
      </Card>
    </div>
