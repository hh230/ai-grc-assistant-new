...
| [0067](./0067-sector-knowledge-packs.md) | Sector Knowledge Packs — Claude authors sector questions ONCE per sector; human-approved, activated by an explicit release pointer, frozen once released, and pinned to every assessment | Accepted with changes | §1, §6, §9, §13, §15, §19 |
